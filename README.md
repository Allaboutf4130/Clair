...
5. Look for the main app file. It may be named `Clair.exe` or a similar Windows file.
6. Double-click the file to start Clair.
...
3. Add any needed details, such as dates, names, or goals.
4. Ask Clair to break the task into steps.
5. Review the answer and the checks.
6. Save useful results for later use.
...
Example:
- Good: “Help me make a step-by-step plan for moving to a new apartment next month.”
- Less clear: “Help me with moving.”
...
1. Enter the task
2. Let Clair break it down
3. Review the steps
4. Check the result
5. Save the output
6. Return to it later if needed
